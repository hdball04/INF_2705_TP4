...
} varsUnif = { 25.0, 0.0, float(1.0/60.0), float(10.0), 9.0 };
...
void FenetreTP::initialiser()
{
    ...
    glm::vec4 couleurFond( 0.44, 0.74, 0.88, 1.0 );
...
void afficherModele()
{
    ...
    switch ( Etat::texnumero ) // 0-aucune, 1-mario, 2-le soleil
    {
    default: glBindTexture( GL_TEXTURE_2D, 0 ); break;
    case 1: glBindTexture( GL_TEXTURE_2D, Etat::textureMARIO); break;
    case 2: glBindTexture( GL_TEXTURE_2D, Etat::textureSOLEIL); break;
    }
...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_t: // Changer la texture utilisée: 0-aucune, 1-mario, 2-soleil
